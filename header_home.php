            ...
            <div class="header-wrapper m--0 rn-popup-mobile-menu row align-items-center">
                ...
                <div class="col-lg-2 col-6">
                    <div class="header-left">
                        <div class="logo">
                            <a href="<?= ROOT_URL ?>">
                            <img src="assets/images/logo/logos-circle.jpg" alt="logo" style="border-radius:100%; width:50px; height:50px">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-center">
                        <nav id="sideNav" class="mainmenu-nav navbar-example2">
                            ...
                            <ul class="primary-menu nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link " href="<?= ROOT_URL ?>/portfolio">Galeria</a></li>
