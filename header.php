...
<body class="template-color-1 front-end-developer spybody white-version" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
        ...
        <div class="header-wrapper rn-popup-mobile-menu m--0 row align-items-center">
            ...
            <div class="col-lg-2 col-6">
                <div class="header-left">
                    <div class="logo">
                        <a href="<?= ROOT_URL ?>">
                            <img src="assets/images/logo/logos-circle.jpg" style="border-radius:100%; width:50px; height:50px" st alt="logo">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="header-center">
                    <nav id="sideNav" class="mainmenu-nav navbar-example2 d-none d-xl-block">
                        ...
                        <ul class="primary-menu nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link " href="<?= ROOT_URL ?>about">Sobre</a>
                            </li>
                            <li class="nav-item"><a class="nav-link " href="<?= ROOT_URL ?>portfolio">Galeria</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="<?= ROOT_URL ?>contact">Contacte</a></li>
                        </ul>
                        <!-- End Mainmanu Nav -->
                    </nav>
                    <!-- Start Header Right  -->
                    <div class="header-right">
                        <a class="rn-btn"  href="tel:+917428648930"><span>Ligue já</span></a>
    ...
    <div class="popup-mobile-menu">
        <div class="inner">
            <div class="menu-top">
                <div class="menu-header">
                    <a class="logo" href="index.html">
                        <img src="assets/images/logo/logos-circle.jpg" style="border-radius:100%; width:50px; height:50px" alt="Personal Portfolio">
                    </a>
            ...
            <div class="content">
            <ul class="primary-menu nav nav-pills">
                            <li class="nav-item"><a class="nav-link smoth-animation active" href="<?= ROOT_URL ?>">Início</a></li>
                            <li class="nav-item"><a class="nav-link smoth-animation" href="<?= ROOT_URL ?>about">Sobre</a>
                            </li>
                            <li class="nav-item"><a class="nav-link smoth-animation" href="<?= ROOT_URL ?>portfolio">Projectos</a>
                            </li>
                            <li class="nav-item"><a class="nav-link smoth-animation" href="<?= ROOT_URL ?>contact">Contacte</a></li>>
                        </ul>
                <!-- social sharea area -->
